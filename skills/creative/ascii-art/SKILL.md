...
```bash
python3 -m pyfiglet "MYAGENT" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=MYAGENT&font=Slant" | boxes -d stone
```
