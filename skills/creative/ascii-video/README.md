...
Built for [MyAgent](https://github.com/NousResearch/myagent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/myagent/skills/creative/ascii-video`](https://github.com/NousResearch/myagent/tree/main/skills/creative/ascii-video) via PR.
